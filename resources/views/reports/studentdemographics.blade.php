<x-header>
    ...
    <h3 class="text-center m-1">data on this page is specific to salisbury univeristy and is from the <a class="underline text-red-800" href="https://collegescorecard.ed.gov/data/documentation/" target="_blank">department of education</a> </h3>
