    ...
    <div class="flex justify-center ">
        <form method="POST" action="{{route('professors.store')}}" >
            ...
            <div class="m-4">
                ...
                <input class="border-2 border-black" name="firstName" type="text">
            </div>
            <div class="m-4">
                <label class="mr-2">Last Name</label>
                <input class="border-2 border-black" name="lastName" type="text">
            </div>
            
            <div class="m-4">
                <label class="mr-2">Department Code</label>
                <input class="border-2 border-black" name="department" type="text">
            </div>
