...
<x-subHeader title="about"/>
    <div class="flex justify-center">
        <div class="max-w-3xl bg-white mt-16  rounded-lg shadow-lg shadow-black p-2 divide-y-4 divide-sky-500 divide-dotted">
            <p class="text-2xl m-4 p-4">This site is a forum for course and professor information that is focused on constructive and quantitative feedback. Many educational review sites 
