...
<div id="defaultModal" tabindex="-1" aria-hidden="true" class=" flex overflow-y-auto overflow-x-hidden  top-0 right-0 left-0 z-50 justify-center items-center w-full md:inset-0 h-modal md:h-full">
    <div class="relative p-4 w-full max-w-2xl h-full md:h-auto">
        <div class="group relative p-4 shadow-lg shadow-black bg-white hover:bg-red-700 group rounded-lg  sm:p-5">
            <div class="flex justify-between items-center pb-4 mb-4 rounded-t border-b sm:mb-5 border-yellow-500 ">
            ...
            <form action="{{route("reviews.store")}}" method="post">
                ...
                <div class="  mb-4">
                    <div class="p-2">
                        <label  class="block mb-2 font-bold text-md text-black group-hover:text-gray-300">Department</label>
                    ...
                    <span class="col-span-2" id="courseProfessorSelection">
                        <div class="p-2">
                            <label for="courseSelection" class="block mb-2 font-bold text-md text-black group-hover:text-gray-300">Course</label>
                        ...
                        <div class="p-2">
                            <label for="professorSelection" class="block mb-2 text-md font-bold text-black group-hover:text-gray-300">Professor</label>
                    ...
                    <div class="sm:col-span-3 p-2">
                        <label for="description" class="block mb-2 text-md font-bold text-gray-900 group-hover:text-gray-300">Review</label>
                ...
                <button type="submit" class="m-2  border-4 border-yellow-500 hover:text-gray-300 bg-yellow-500 rounded font-bold px-1 flex">
