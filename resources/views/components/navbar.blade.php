<nav class="p-3   text-xl font-sans font-bold px-5 py-2 rounded-lg">
    @auth
        ...
        <a href="{{route("reviews.create")}}" class=" decoration-sky-500 decoration-4 hover:underline px-5 py-2 rounded-lg bold ">new review</a> 
        <a href="/home" class=" decoration-sky-500 decoration-4 hover:underline px-5 py-2 rounded-lg bold ">home</a> 
