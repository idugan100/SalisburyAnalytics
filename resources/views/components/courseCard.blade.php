<div class="  contrast-125 group p-3 shadow-lg  shadow-black  bg-white hover:bg-sky-500 rounded-lg m-2 p-5 ">
    ...
    <div class=" py-1 px-2 m-2  text-md font-bold bg-gray-300 rounded border-3 boder-gray-300"> {{"Total Students since 2017: " . $course->qty_A + $course->qty_B + $course->qty_B + $course->qty_C + $course->qty_D + $course->qty_F + $course->qty_W}}</div>
